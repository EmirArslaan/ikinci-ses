...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-gray-200 bg-white/95 backdrop-blur-md px-4 lg:px-10 py-3">
            <div className="flex items-center gap-4 lg:gap-8 w-full max-w-[1280px] mx-auto">
                {/* Logo */}
                <Link className="flex items-center gap-3 text-gray-900 hover:opacity-80 transition-opacity" href="/">
                    ...
                    <h2 className="text-gray-900 text-lg font-bold leading-tight tracking-[-0.015em] hidden sm:block">İkinci Ses</h2>
                </Link>
                ...
                <div className="flex flex-1 justify-end gap-4 lg:gap-8 items-center">
                    <nav className="hidden lg:flex items-center gap-6">
                        ...
                        <Link className="text-gray-600 text-sm font-medium hover:text-[#8B4513] transition-colors" href="/listings">İlanlar</Link>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <Link
                                    ...
                                    className="flex items-center justify-center gap-2 rounded-full h-10 px-4 lg:px-5 bg-[#8B4513] hover:bg-[#A0522D] text-white text-sm font-bold transition-colors"
                                >
                            ...
                            <>
                                ...
                                <Link
                                    href="/auth/login"
                                    className="flex items-center justify-center rounded-full h-10 px-4 lg:px-5 bg-white border border-gray-200 hover:border-[#8B4513] text-gray-700 text-sm font-bold transition-colors"
                                >
                                    Giriş Yap
                                </Link>
                            </>
