                ...
                <div className="w-full max-w-[960px] flex flex-col gap-8">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                        <div className="flex flex-col gap-2">
                            <h1 className="text-gray-900 text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em]">Yeni İlan Oluştur</h1>
                            <p className="text-[#6b7280] text-base font-normal leading-normal">Enstrümanını satmak için bilgileri doldur.</p>
                        </div>
                    </div>
